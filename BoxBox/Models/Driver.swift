...
extension Driver {
    ...
    static func fallback(driverCode: String, driverName: String, teamName: String) -> Driver {
        Driver(
            ...
            teamName: teamName,
            teamColour: F1Design.teamColor(for: teamName).toHex(),
            countryCode: "",
            headshotUrl: nil
        )
    }
...
struct DriverProfile {
    ...
    private static let data: [String: DriverProfile] = [
        ...
        "NOR": DriverProfile(nationality: "British", dateOfBirth: "13 Nov 1999", placeOfBirth: "Bristol, England", debutSeason: 2019, championships: 1, careerWins: nil, careerPodiums: nil, careerPoles: nil, bestFinish: "World Champion", juniorTitle: "2018 F2 runner-up", blurb: "Qualifying speed and confidence under pressure improved massively. Now expected to set the benchmark rather than chase it."),
        ...
        "BEA": DriverProfile(nationality: "British", dateOfBirth: "6 May 2005", placeOfBirth: "London, England", debutSeason: 2024, championships: 0, careerWins: nil, careerPodiums: nil, careerPoles: nil, bestFinish: "Rookie season", juniorTitle: "Junior single-seater standout", blurb: "High-upside rookie profile: composure, racecraft and technical feedback matter more than headline results right now."),
        "COL": DriverProfile(nationality: "Argentine", dateOfBirth: "27 May 2003", placeOfBirth: "Pilar, Argentina", debutSeason: 2024, championships: 0, careerWins: nil, careerPodiums: nil, careerPoles: nil, bestFinish: "Rookie season", juniorTitle: "Junior single-seater race winner", blurb: "Exciting but still incomplete. Needs mileage and cleaner weekends before anyone should overhype him."),
