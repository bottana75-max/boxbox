...
enum WidgetTrackData {
    static func points(for circuitId: String) -> [(CGFloat, CGFloat)] {
        ...
        // Singapore
        case "marina_bay":
            return [(40.0,90.0),(30.0,75.0),(20.0,60.0),(25.0,45.0),(35.0,30.0),(50.0,25.0),(65.0,30.0),(75.0,45.0),(65.0,55.0),(55.0,65.0),(45.0,70.0),(40.0,80.0),(40.0,90.0)]
        // Catalunya
        case "catalunya":
        ...
        // Qatar / Lusail
        case "losail":
            return [(50.0,5.0),(70.0,8.0),(85.0,15.0),(95.0,28.0),(95.0,50.0),(88.0,65.0),(75.0,78.0),(60.0,88.0),(45.0,92.0),(30.0,88.0),(18.0,78.0),(8.0,65.0),(5.0,50.0),(8.0,35.0),(18.0,22.0),(35.0,10.0),(50.0,5.0)]
        // Mexico City
        case "rodriguez":
